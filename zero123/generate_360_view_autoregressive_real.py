...
if __name__ == '__main__':
    ...
    inference_temp = 0.5
    auto_temp = 1.0
    output_dir = f'./zero123/experiments_cvpr/pretrain_zero123_xl_360_autoregressive_real/gen_real_elevation60_inference_t{inference_temp:.2f}_auto_t{auto_temp:.2f}_pred_e'
